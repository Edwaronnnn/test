...
func checkGameStatus():
	if attemptsLeft == 0:
		var tree = get_tree()
		if tree:
			SceneTransition.change_scene("res://game_over_2.tscn")
		...
		if tree and attemptsLeft <= 1 :
			SceneTransition.change_scene("res://1 star - 2.tscn")
		elif tree and attemptsLeft <= 3 :
			SceneTransition.change_scene("res://2  star - 2.tscn")
		elif tree and attemptsLeft <= 5 :
			SceneTransition.change_scene("res://3  star - 2.tscn")
